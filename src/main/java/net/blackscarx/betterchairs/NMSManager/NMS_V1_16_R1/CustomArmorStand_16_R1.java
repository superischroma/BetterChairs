...
package net.blackscarx.betterchairs.NMSManager.NMS_V1_16_R1;
...
public class CustomArmorStand_16_R1 extends EntityArmorStand {

    private boolean protect = true;

    public CustomArmorStand_16_R1(World world, double d0, double d1, double d2) {
    ...
    public static ArmorStand spawn(Location location, Player p) {
        ...
        CustomArmorStand_16_R1 customEntity = new CustomArmorStand_16_R1(mcWorld, location.getX(), location.getY(), location.getZ());
        ...
        customEntity.load(nbt);
        customEntity.saveData(nbt);
        nbt.setBoolean("Invisible", true);
        nbt.setInt("DisabledSlots", 2031616);
        customEntity.loadData(nbt);
    ...
    private boolean shouldDie(CustomArmorStand_16_R1 mount) {
